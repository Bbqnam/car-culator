  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        <div className="flex flex-col lg:grid lg:grid-cols-[1fr_440px] gap-6 lg:gap-8">
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 xl:grid-cols-2 gap-4">
              {cars.map((car, i) => (
                <CarCard key={car.id} car={car} index={i} canRemove={cars.length > 1}
          ...
          <div className="lg:sticky lg:top-24 lg:self-start lg:max-h-[calc(100vh-7rem)] lg:overflow-y-auto">
            {results.length > 0 ? (
              ...
              <div className="rounded-2xl border border-border/60 bg-card p-8 text-center">
                <p className="text-sm text-muted-foreground">Select a car to see cost breakdown</p>
              </div>
            )}
          </div>
        </div>
