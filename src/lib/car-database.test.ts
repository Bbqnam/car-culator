...
describe("car-database coverage and pricing", () => {
  ...
  it("keeps detailed model labels instead of collapsing them into families", () => {
    expect(getDisplayModelName("Volvo", "EX90 Twin Motor Performance (21 Inch Wheels)")).toBe("EX90 Twin Motor Performance");
  ...
  it("resolves a local database model from its detailed dropdown label", () => {
